...
# 指定输出版本
npx prompt-optimizer-skill optimize "Write code" --basic      # 基础版
npx prompt-optimizer-skill optimize "Write code" --enhanced   # 增强版（默认）
npx prompt-optimizer-skill optimize "Write code" --expert     # 专家版
```
...
### 方法 A：在 Claude Code 中使用（Marketplace 安装后）
...
### 多版本输出 / Multi-Version Output

根据你的需求，你可以获得不同详细程度的优化结果：

| 版本 | 适用场景 | 特点 |
|------|----------|------|
| **基础版 (Basic)** | 快速使用，简单任务 | 核心要素，简洁明了 |
| **增强版 (Enhanced)** | 日常工作，团队协作 | 完整结构，包含示例 |
| **专家版 (Expert)** | 复杂项目，高质量要求 | 全要素 + 约束条件 + 验证标准 |
...
**优化后（增强版）/ After (Enhanced Version):**
```markdown
# Role
...
## 📚 框架库 / Framework Library

### 简单框架 (≤3 元素) / Simple Frameworks
